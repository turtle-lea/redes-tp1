...
El valor de la entropía para el gráfico de fuente SRC es $2.05$
El valor de la entropía para el gráfico de fuente DST es $2.99$
...
utilizados durante largos per\'iodos dentro de la red. Quiz\'as esto permite detectar
